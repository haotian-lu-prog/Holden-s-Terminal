...
import { exposureByAssetClass, exposureByCurrency, netWorth, totalCash, totalCostBasis, totalDebt, totalMarketValue, unrealizedProfitLoss, unrealizedProfitLossPercent } from "../lib/portfolio.js";
...
export function renderDashboard(state) {
    ...
    ${SectionHeader({
        ...
        description: "Net worth, exposures, research state, and decision queue in one dense cockpit.",
