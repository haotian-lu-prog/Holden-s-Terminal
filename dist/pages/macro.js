...
export function renderMacro(state) {
    return `
    ${SectionHeader({
        eyebrow: "Macro",
        title: "Macro Indicators",
        description: "Mock macro board for USDJPY, rates, volatility, commodities, CPI, and policy-rate placeholders.",
...
function indicatorMetric(indicator) {
    return MetricCard({
