...
const decisionTypes = ["buy", "sell", "hold", "rebalance", "observe"];
export function renderJournal(state) {
    ...
    ${SectionHeader({
        ...
        description: "Record the reasoning, expected outcome, review date, and eventual result before hindsight edits the story.",
