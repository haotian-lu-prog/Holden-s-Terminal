import type { TerminalState } from "../types/investment.js";

export function createMockState(): TerminalState {
  return {
    schemaVersion: 2,
    accounts: [
      {
    ...
    researchTopics: [
      {
        ...
        thesis:
          "Enterprise and hyperscaler AI spend can stay elevated if inference workloads absorb capacity and power availability remains the bottleneck.",
      ...
      },
      {
        ...
        thesis:
          "Tokyo Stock Exchange pressure and buyback discipline can support selected Japan quality/value names.",
      ...
      },
      {
        ...
        thesis:
          "Long-duration bonds become attractive if growth slows faster than inflation expectations rise.",
      ...
      },
      {
        ...
        thesis:
          "Gold deserves a modest allocation while fiscal credibility and reserve diversification remain live risks.",
    ...
    journalEntries: [
      {
        ...
        asset: "MSFT",
        rationale:
          "Maintain position. Cloud and enterprise AI distribution remain thesis-consistent, but valuation leaves little room for sloppy sizing.",
        expectedOutcome:
          "Azure growth and AI attach rates should remain resilient through the next two earnings cycles.",
      ...
      },
      {
        ...
        asset: "TLT",
        rationale:
          "Do not add duration yet. Inflation data and term premium are not aligned enough for a clean risk/reward.",
        expectedOutcome:
          "A better setup requires softer labor data or a clear break in services inflation.",
      ...
      },
      {
        ...
        asset: "SGOV / cash",
        rationale:
          "Move excess idle USD cash into short-duration Treasury exposure while keeping optionality for researched ideas.",
        expectedOutcome:
          "Incremental yield pickup without adding meaningful duration or equity beta.",
