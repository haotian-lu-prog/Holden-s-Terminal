...
import type { StrategicValue, Subscription, TerminalState } from "../types/investment.js";

const strategicValues: StrategicValue[] = ["research", "AI", "infra", "media", "learning"];

export function renderSubscriptions(state: TerminalState): string {
  ...
  return `
    ${SectionHeader({
      ...
      description:
        "Track research, AI, infrastructure, media, and learning subscriptions by renewal and annualized cost.",
...
function countByValue(subscriptions: Subscription[], value: StrategicValue): number {
