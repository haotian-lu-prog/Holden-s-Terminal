...
import type { Account, TerminalState } from "../types/investment.js";

export function renderPortfolio(state: TerminalState): string {
  ...
  return `
    ${SectionHeader({
      ...
      description:
        "Accounts, holdings, allocation, country and currency exposure, unrealized P/L, and concentration risk.",
...
function accountsTable(accounts: Account[]): string {
  return `
